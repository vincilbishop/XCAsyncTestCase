...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/iiiyu/XCAsyncTestCase.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "XCAsyncTestCase", "XCAsyncTestCase/**/*.{h,m}"
  s.exclude_files = "XCAsyncTestCase/Exclude"
